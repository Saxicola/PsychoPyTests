...
# -*- coding: utf-8 -*-
"""
This experiment was created using PsychoPy2 Experiment Builder (v1.80.03), srpen 19, 2014, at 13:19
...
expName = u'Menrot'  # from the Builder filename that created this script
...
for thisTrial in trials:
    ...
    while continueRoutine:
        ...
        if odpoved.status == STARTED:
            ...
            if t>=1.5:
                #kamil - po tehle komponente chci ukoncit, at zmacknul klavesu nebo ne
                continueRoutine = False
