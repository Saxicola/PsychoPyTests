...
# -*- coding: utf-8 -*-
"""
This experiment was created using PsychoPy2 Experiment Builder (v1.79.01), 2014_06_19_2047
...
trials = data.TrialHandler(nReps=1, method=u'sequential', 
    ...
    trialList=data.importConditions(u'menrotIIIconditions2016.csv'),
...
for thisTrial in trials:
    ...
    while continueRoutine:
        ...
        elif image.status == STARTED and t >= (0 + 2):
        ...
        elif test_cross.status == STARTED and t >= (2 + 1.5):
