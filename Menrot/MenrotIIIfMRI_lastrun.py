...
# -*- coding: utf-8 -*-
"""
This experiment was created using PsychoPy2 Experiment Builder (v1.80.03), srpen 19, 2014, at 13:18
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath=u'D:\\prace\\programovani\\psychopy\\Menrot\\MenrotIIIfMRI.psyexp',
...
trials = data.TrialHandler(nReps=1, method=u'sequential', 
    extraInfo=expInfo, originPath=u'D:\\prace\\programovani\\psychopy\\Menrot\\MenrotIIIfMRI.psyexp',
    trialList=data.importConditions(u'menrotIIIfMRIconditions.csv'),
