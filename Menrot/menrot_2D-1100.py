...
#pport_addrr = 0x2FF8 #0x0378 - pocitac #0x2FF8 - notebook, FEL michal 0x2FE8 

#SETUP kamil 21.1.2014
experiment_name = 'menrot_2D'
image_example = '2D-000l-1100.jpg'
csv_file = u'menrot_2D-1100.csv'
screenSize = (1600,900)
screenMonitor = 1 #0=levy,1=pravy
image_folder = 'imagesR'

# Store info about the experiment session
expName = experiment_name  # from the Builder filename that created this script
...
# Setup the Window
win = visual.Window(size=screenSize, fullscr=True, screen=screenMonitor, allowGUI=False, allowStencil=False,
...
image = visual.ImageStim(win=win, name='image',
    image=image_folder+'/'+image_example, mask=None, #kamil
...
for thisTrial in trials:
    ...
    frameN = -1
    # update component parameters for each repeat
    image.setImage(image_folder+'/'+obrazek)
    ...
    while continueRoutine:
        ...
        if t >= 1 and image.status == NOT_STARTED:
            ...
            #kamil
            #pport.Out32(pport_addrr, 255) # sets all pins to low 255
