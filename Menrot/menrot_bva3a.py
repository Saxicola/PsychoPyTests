...
# -*- coding: utf-8 -*-
"""
This experiment was created using PsychoPy2 Experiment Builder (v1.79.01), leden 09, 2014, at 14:42
...
LPT = parallel.ParallelPort(address=u'0x0378')
...
for thisTrial in trials:
    ...
    while continueRoutine:
        ...
        if t >= 1 and LPT.status == NOT_STARTED:
            ...
            pport.Out32(0x0378,255) # sets pin no.1 to high
        elif LPT.status == STARTED and t >= (1 + 2):
            LPT.status = STOPPED
            win.callOnFlip(LPT.setData, int(0))
            pport.Out32(0x0378,0) # sets pin no.1 to high
        # *ISI* period
