...
# -*- coding: utf-8 -*-
"""
This experiment was created using PsychoPy2 Experiment Builder (v1.79.01), 2014_06_19_1448
...
#verze z konstantni delkou prezentace obrazku a krizku - 1.5+1.5s
#19.6.2014
#oprava 1.10.2014

expName = 'AEdistIII'  # from the Builder filename that created this script
...
for thisTrial in trials:
    ...
    for thisLoopPauza in loopPauza:
        ...
        while continueRoutine and routineTimer.getTime() > 0:
            ...
            elif text_precross.status == STARTED and t >= (0.0 + 1.0):
    ...
    while continueRoutine:
        ...
        elif image.status == STARTED and t >= (0 + 1.5):
        ...
        elif test_cross.status == STARTED and t >= (1.5 + 1.5):
    ...
    for thisLoopFeedback in loopFeedback:
        ...
        while continueRoutine and routineTimer.getTime() > 0:
            ...
            elif textFeedBack.status == STARTED and t >= (0.0 + 2):
