...
# -*- coding: utf-8 -*-
"""
This experiment was created using PsychoPy2 Experiment Builder (v1.79.01), srpen 20, 2014, at 13:20
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath=u'D:\\prace\\programovani\\psychopy\\AEDist\\AEdistRG2fMRI.psyexp',
...
trials = data.TrialHandler(nReps=1, method=u'sequential', 
    extraInfo=expInfo, originPath=u'D:\\prace\\programovani\\psychopy\\AEDist\\AEdistRG2fMRI.psyexp',
    trialList=data.importConditions(u'AEDistRGfMRI.csv'),
...
for thisTrial in trials:
    ...
    for thisLoopPauza in loopPauza:
        ...
        while continueRoutine and routineTimer.getTime() > 0:
            ...
            elif text.status == STARTED and t >= (0.5 + (3-win.monitorFramePeriod*0.75)): #most of one frame period left
