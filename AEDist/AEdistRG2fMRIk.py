...
# -*- coding: utf-8 -*-
"""
This experiment was created using PsychoPy2 Experiment Builder (v1.79.01), srpen 20, 2014, at 13:21
    ...
    while continueRoutine:
        ...
        if odpoved.status == STARTED:
            ...
            if len(theseKeys) > 0:  # at least one key was pressed
                ...
                #continueRoutine = False #kamil klavesa nekonci trial
            if t> 1.5:
                continueRoutine = False #kamil cas 1.5s konci trial
