...
# -*- coding: utf-8 -*-
"""
This experiment was created using PsychoPy2 Experiment Builder (v1.79.01), 2015_05_19_1449
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath=u'D:\\prace\\programovani\\psychopy\\AEDist\\AEdistRG2.psyexp',
...
trials = data.TrialHandler(nReps=1, method='sequential', 
    extraInfo=expInfo, originPath=u'D:\\prace\\programovani\\psychopy\\AEDist\\AEdistRG2.psyexp',
...
for thisTrial in trials:
    ...
    while continueRoutine:
        ...
        elif test_cross.status == STARTED and t >= (1.5 + (1.5-win.monitorFramePeriod*0.75)): #most of one frame period left
