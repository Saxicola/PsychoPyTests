...
# -*- coding: utf-8 -*-
"""
This experiment was created using PsychoPy2 Experiment Builder (v1.80.03), 2016_02_14_0911
...
expName = 'sublim'  # from the Builder filename that created this script
...
image_noise = visual.ImageStim(win=win, name='image_noise',
    image='maxresdefault.jpg', mask=None,
...
image_noise_inverse = visual.ImageStim(win=win, name='image_noise_inverse',
    image='maxresdefault_Inverse.jpg', mask=None,
    ori=0, pos=[0, 0], size=[2, 2],
    color=[1,1,1], colorSpace='rgb', opacity=1,
    flipHoriz=False, flipVert=False,
