...
# -*- coding: utf-8 -*-
"""
This experiment was created using PsychoPy2 Experiment Builder (v1.80.03), srpen 21, 2014, at 13:45
...
expName = u'PPAlocalizer'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath=u'D:\\prace\\programovani\\psychopy\\PPAlocalizer\\PPAlocalizer.psyexp',
...
krizek_pauza = visual.ImageStim(win=win, name='krizek_pauza',
    image=u'imagesFMRI/cross.jpg', mask=None,
...
trials = data.TrialHandler(nReps=1, method=u'sequential', 
    extraInfo=expInfo, originPath=u'D:\\prace\\programovani\\psychopy\\PPAlocalizer\\PPAlocalizer.psyexp',
    trialList=data.importConditions(u'PPAconditions.csv'),
...
for thisTrial in trials:
    ...
    for thisLoopPauza in loopPauza:
        ...
        while continueRoutine and routineTimer.getTime() > 0:
            ...
            if t >= 0.0 and krizek_pauza.status == NOT_STARTED:
            ...
            elif krizek_pauza.status == STARTED and t >= (0.0 + (3.0-win.monitorFramePeriod*0.75)): #most of one frame period left
    ...
    while continueRoutine:
        ...
        elif image.status == STARTED and t >= (0.0 + (0.400-win.monitorFramePeriod*0.75)): #most of one frame period left
            image.setAutoDraw(False)
        
        # *krizek* updates
        if t >= 0.400 and krizek.status == NOT_STARTED:
            # keep track of start time/frame for later
        ...
        elif krizek.status == STARTED and t >= (0.400 + (0.350-win.monitorFramePeriod*0.75)): #most of one frame period left
