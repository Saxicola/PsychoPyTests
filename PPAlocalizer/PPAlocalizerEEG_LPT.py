...
# -*- coding: utf-8 -*-
"""
This experiment was created using PsychoPy2 Experiment Builder (v1.80.03), 2014_10_02_0954
...
for thisTrial in trials:
    ...
    # set up handler to look after randomisation of conditions etc
    pauza_loop = data.TrialHandler(nReps=pauza, method=u'random', 
        extraInfo=expInfo, originPath=None,
        trialList=[None],
    ...
    while continueRoutine and routineTimer.getTime() > 0:
        ...
        elif odpoved.status == STARTED and t >= (0.0 + (1-win.monitorFramePeriod*0.75)): #most of one frame period left
        ...
        if krizek.status == STARTED and t>=2:
