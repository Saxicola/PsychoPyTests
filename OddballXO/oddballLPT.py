...
# -*- coding: utf-8 -*-
"""
This experiment was created using PsychoPy2 Experiment Builder (v1.80.03), 2015_10_05_1317
...
pport_addrr = 0x2FF8 #0x0378 - pocitac #0x2FF8 - notebook #0xDC00 - novy experimentalni pocitac
...
text_pauza = visual.TextStim(win=win, ori=0, name='text_pauza',
    text=u'Mezern\xedk pro pokra\u010dov\xe1n\xed',    font=u'Arial',
...
text_trial = visual.TextStim(win=win, ori=0, name='text_trial',
    ...
    color=u'blue', colorSpace=u'rgb', opacity=1,
    depth=-2.0)
...
while continueRoutine:
    ...
    # vymazu, protoze nechci limit 3
    #elif key_resp_instr.status == STARTED and t >= (0.0 + (3-win.monitorFramePeriod*0.75)): #most of one frame period left
    #    key_resp_instr.status = STOPPED
...
for thisTrial in trials:
    ...
    # set up handler to look after randomisation of conditions etc
    trials_pauza = data.TrialHandler(nReps=pauza, method=u'random', 
        extraInfo=expInfo, originPath=None,
        trialList=[None],
